...
function contentfulFactory (contentType) {
  return {
    ...
    contentful: {
      ...
      entry_template: `${contentType.template || `${contentType.slug.singular}.pug`}`,
      entry_filename_pattern: contentType.filenamePattern || `${contentType.slug.plural}/${'${'} ${contentType.contentfulFilenameField} ${'}'}`,
      limit: 1000,
